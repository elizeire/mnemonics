...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "mnemonics@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "mnemonics API";

        private String description = "mnemonics API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "mnemonics";
